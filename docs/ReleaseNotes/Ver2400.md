...
Virtual Firewalls have transformed from the beta phase and become a fully supported feature, enabling cloud users to use Virtual Firewalls in a Virtualized Network Function (VNF) style. Key features include support for multiple VLANs and Public IPv4 addresses and automated service activation. Additionally, service providers will gain enhanced monetisation options for firewall components, and  cloud subscribers will benefit from more robust firewall management capabilities.
...
- Service Provider Admins can manage the lifecycle, templates, and monitoring through  SP Admin, Apache CloudStack, and Zabbix.
...
:::note
This feature is experimental. IPv6 network routing control in guest, shared and VPC Network Tiers is outside  management (A limitation on CloudStack).
:::
