...
Use the **Date** and **All Models** filter to display a limited number of uploaded firmware details.![Uploaded Firmware](img/UploadedFW.png)

## Viewing Firmware Jobs
To view the list of firmware jobs, navigate to the **JOB** tab.
Use the **Date** filter to display a limited number of firmware jobs.![Uploaded Firmware](img/FirmwareJobs.png)