...
1. Navigate to **Assets** > **Locations Management**. The following screen appears, which displays a comprehensive list of locations along with the associated details in tabular format:![Managing Locations](img/ManagingLocations.png)
2. Click on the **Add New Location** button. The following screen appears:![Add New Location](img/AddLocation.png)
3. Click and select ![Marker](img/Marker.png)  (marker icon) and drop it on the map to the new location.
	:::note
...
3. Click **Next**. The following screen appears:![Add Timings 24/7](img/AddTimings247.png)
4. Add the timings of operations for the location. Select **Open 24/7** or **Customized** from the Timings drop-down list.
	...
	2. Select **Customized** to set the custom timings of operations for the location.![Add Timings](img/AddTimingsCustom.png)
5. Click **Next**. The following screen appears: ![Select Facilities](img/SelectFacilites.png)
