...
### Managing Info
Click on the **Info** tab. The screen displays the basic details associated with the location:![Location Info](img/Info.png)

To edit the location details, click on the **Edit** button, make the desired changes, and click the **Save** button.![Edit Info](img/EditInfo.png)
...
To edit the notes, click on the **Edit** button, make the desired changes to the notes, and click the **Save** button.![Edit Info](img/EditNotes.png)
...
### Viewing Reviews
Click on the **Reviews** tab. The screen displays reviews provided by the customers:![Reviews](img/Reviews.png)
