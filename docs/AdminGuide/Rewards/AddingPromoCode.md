...
1. Navigate to **Rewards** > **Add New Promo Code**. The New Promo Code screen appears.
	- **Scenario 1**: When you want to provide a flat discount.![Add Promo Code](img/Add2.png)
	...
	- **Scenario 2**: When you want to provide the discount as a percentage of the invoice value.![Add Promo Code](img/Add1.png)
		- Enter the **Promo Name**.
